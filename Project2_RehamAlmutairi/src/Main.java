...
public class Main {
    public static void main(String[] args) {
        ...
        Car car_3 = new Car("#14242",route_2,0);
        ...
        passengers.add(new NonSubscribers_passengers("Mohammed","103",car_3,false));

        for (int i = 0; i < passengers.size(); i++) {
            if(passengers.get(i).compute_Tripcost() != 0){ // if method return zero when throws the maximum passengers
